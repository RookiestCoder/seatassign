(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("SeatAssign", [], factory);
	else if(typeof exports === 'object')
		exports["SeatAssign"] = factory();
	else
		root["SeatAssign"] = factory();
...
;// ./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/seatAssign/index.vue?vue&type=template&id=1f38e9e7&scoped=true
var render = function render() {
  var _vm = this,
    _c = _vm._self._c;
  return _c('div', {
    staticClass: "com-seatAssign"
  }, [_c('div', {
  ...
  }, [_vm.roundConfig.btnVisiable.indexOf('reset') > -1 ? _c('div', {
    attrs: {
      "size": "mini"
    },
    on: {
      "click": _vm.resetRoundTableSeat
    }
  }, [_vm._v(" 重置座位 ")]) : _vm._e(), _vm.roundConfig.btnVisiable.indexOf('staging') > -1 ? _c('div', {
    attrs: {
      "size": "mini"
    },
    on: {
      "click": _vm.saveCurrentPosition
    }
  }, [_vm._v(" 暂存分布 ")]) : _vm._e(), _vm.roundConfig.btnVisiable.indexOf('staging') > -1 ? _c('div', {
    attrs: {
      "size": "mini"
    },
    on: {
      "click": _vm.recoveryPosition
    }
  }, [_vm._v(" 恢复暂存 ")]) : _vm._e(), _vm.roundConfig.btnVisiable.indexOf('saveImg') > -1 ? _c('div', {
    attrs: {
      "size": "mini"
    },
    on: {
      "click": _vm.savetolocal
    }
  }, [_vm._v(" 保存图片 ")]) : _vm._e()]), _c('div', {
    staticClass: "table"
  }, [_vm.$scopedSlots.table ? _c('div', {
    staticClass: "tableSlot"
  }, [_vm._t("table")], 2) : _c('div', {
    staticClass: "roundTable"
  })]), _vm._l(_vm.roundConfig.PersonList, function (item, index) {
    return _c('div', {
      key: index,
      staticClass: "singleSeat"
    }, [_vm.$scopedSlots.seat ? [_vm._t("seat", null, {
      "seatInfo": item,
      "index": index
    })] : _c('div', {
      staticClass: "singleSeat-default"
...
var html2canvas = __webpack_require__(132);
var html2canvas_default = /*#__PURE__*/__webpack_require__.n(html2canvas);
;// ./src/components/seatAssign/prop.js
const props = {
  //圆桌配置
  roundConfig: {
    type: Object,
    default() {
      return {
        ...
        tableDistance: 10,
        //座位和圆桌的距离
        btnVisiable: ['reset', 'staging', 'saveImg'],
        //reset重置座位，staging暂存分布及恢复暂存，saveImg保存图片
        assignType: 'normal' //选座模式1.free自由拖拽，2.exchange座位互换，3.slide滑动互换
      };
    }
  }
};
/* harmony default export */ var prop = (props);
;// ./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib/index.js??clonedRuleSet-82.use[1]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/seatAssign/index.vue?vue&type=script&lang=js





/* harmony default export */ var seatAssignvue_type_script_lang_js = ({
  name: "seatAssign",
  props: prop,
  data() {
    return {
  ...
  methods: {
    ...
    resetRoundTableSeat() {
      let seatList = document.getElementsByClassName("singleSeat");
      for (let i = 0; i < seatList.length; i++) {
        let middleLeft = this.roundConfig.boxWidth / 2 - this.roundConfig.seatDiameter / 2;
        let middleTop = this.roundConfig.boxHeight / 2 - this.roundConfig.seatDiameter / 2;
        let rad = 2 * Math.PI / this.roundConfig.PersonList.length * i - Math.PI / 2;
        let x = (this.roundConfig.tableDiameter / 2 + this.roundConfig.seatDiameter / 2 + this.roundConfig.tableDistance) * Math.cos(rad);
        let y = (this.roundConfig.tableDiameter / 2 + this.roundConfig.seatDiameter / 2 + this.roundConfig.tableDistance) * Math.sin(rad);
    ...
    changeSeatLocation() {
      ...
      for (let i = 0; i < seatList.length; i++) {
        ...
        let rad = 2 * Math.PI / this.roundConfig.PersonList.length * i - Math.PI / 2; //角度
        ...
        let putDown = event => {
          ...
          document.onmousemove = event => {
            ...
            if (parseInt(seatList[i].style.left) >= window.innerWidth - parseInt(seatList[i].style.width)) {
              seatList[i].style.left = window.innerWidth - parseInt(seatList[i].style.width) + "px";
            }
            if (parseInt(seatList[i].style.top) >= window.innerHeight - parseInt(seatList[i].style.height)) {
              seatList[i].style.top = window.innerHeight - parseInt(seatList[i].style.height) + "px";
            }
          };
  ...
  mounted() {
    ...
    let hasPos = this.roundConfig.PersonList.every(pos => {
      return pos.initialX && pos.initialY && pos.initialY != "" && pos.initialX != "";
    });
    if (hasPos) {
      this.resetInterPos();
    } else {
...
;// ./src/components/seatAssign/index.vue?vue&type=script&lang=js
 /* harmony default export */ var components_seatAssignvue_type_script_lang_js = (seatAssignvue_type_script_lang_js); 
;// ./node_modules/mini-css-extract-plugin/dist/loader.js??clonedRuleSet-74.use[0]!./node_modules/css-loader/dist/cjs.js??clonedRuleSet-74.use[1]!./node_modules/@vue/vue-loader-v15/lib/loaders/stylePostLoader.js!./node_modules/postcss-loader/dist/cjs.js??clonedRuleSet-74.use[2]!./node_modules/less-loader/dist/cjs.js??clonedRuleSet-74.use[3]!./node_modules/@vue/vue-loader-v15/lib/index.js??vue-loader-options!./src/components/seatAssign/index.vue?vue&type=style&index=0&id=1f38e9e7&prod&lang=less&scoped=true
// extracted by mini-css-extract-plugin

;// ./src/components/seatAssign/index.vue?vue&type=style&index=0&id=1f38e9e7&prod&lang=less&scoped=true
...
;// ./src/components/seatAssign/index.vue
...
var component = normalizeComponent(
  components_seatAssignvue_type_script_lang_js,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var seatAssign = (component.exports);
;// ./src/main.js
...
//# sourceMappingURL=seatassign.umd.js.map